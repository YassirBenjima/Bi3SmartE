    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('C_id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnop123456789', length=10, max_length=20, prefix='cat', unique=True)),
                ('title', models.CharField(default='Title Category', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('p_id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnop123456789', length=10, max_length=20, prefix='', unique=True)),
                ('title', models.CharField(default='Title Product', max_length=100)),
                ...
                ('specefications', models.TextField(blank=True, null=True)),
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet='123456789', length=4, max_length=20, prefix='sku', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('v_id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnop123456789', length=10, max_length=20, prefix='ven', unique=True)),
                ('title', models.CharField(default='Title Vendor', max_length=100)),
                ...
                ('address', models.CharField(default='Main Street,Marrakech', max_length=100)),
                ('contact', models.CharField(default='+212 659 394 401', max_length=100)),
